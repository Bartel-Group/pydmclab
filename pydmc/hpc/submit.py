...
class SubmitTools(object):
    ...
    def __init__(self,
        ...
        if ('gga' in final_xcs) and ('metagga' in final_xcs):
            warnings.warn('You have both gga and metagga in final_xcs. This is probably not what you want. I\'m going to remove gga from final_xcs since you get it for free w/ metagga')
