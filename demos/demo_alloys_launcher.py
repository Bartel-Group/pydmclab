...
# Uncomment the following line if doing STRAINED SQS calculations (ie strained to a substrate)

# INCAR_MODS = {"all-all": {"LATTICE_CONSTRAINTS": "F F T"}} # for orthorhombic cells. See VASP docs for non-orthorhombic cells
...
def main():
    ...
    strucs = get_sqs_strucs(
        oriented_end_member_A_path={{"TEMPLATE_CIF_FILE"}},
        oriented_end_member_B_path={{"TEMPLATE_CIF_FILE"}},
        supercell={{"LIST OF SUPERCELL DIMENSIONS"}},
        substrate_path=None, #specify a path if you want your alloys to be strained to a substrate
        strain=False, #set to True if you want your alloys to be strained to a substrate
