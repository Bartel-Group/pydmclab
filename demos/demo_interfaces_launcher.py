...
SUB_CONFIGS = get_sub_configs(
    ...
    custom_calc_list=['gga-relax', 'gga-static'],
...
SLURM_CONFIGS = get_slurm_configs(
    ...
    mem_per_core="all",
    partition="preempt,agsmall,msismall,msidmc",
    error_file="log.e",
    output_file="log.o",
    account="cbartel",
)
...
def main():
    ...
    if GEN_MAGMOMS:
        ...
        #     check_magmoms(strucs=interfaces, magmoms=magmoms)
    else:
        magmoms = None
    ...
    get_interfacial_energy(data_dir = DATA_DIR,
