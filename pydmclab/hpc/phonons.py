    ...
    def __init__(self, unitcell: str|dict,
        ...
        Args:
            ...
            primitive_matrix (list):
                ...
                It's nice to feed primitive matrix so that the band structure can be plotted in the primitive cell Brillouin zone. 
...
class Gibbs():
    def __init__(self, phonon_dos_dict, 
                 eos="vinet", 
                 temperatures=np.linspace(0, 2000, 101), 
                 normalize = None):
        ...
        Returns:
            dict
                {volume (A**3) :
                    {'data' :
                        [{'T' : temperature (K),
                        'F' : Helmholtz free energy (eV/cell or eV/normalize)},
...
##new to do: fix so it doesn't recalculate helmholtz properties if already exists in dos_dict
