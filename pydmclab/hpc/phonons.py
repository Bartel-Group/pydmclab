...
class AnalyzePhonons(object):
    def __init__(self, unitcell: str|dict = None,
        ...
        Args:
            ...
            dataset (dict):
                Dictionary containing displacement information, can optionally include forces and supercell energy. But these can also be provided separately in force_data, this easier because you can just feed it as a list of arrays.
